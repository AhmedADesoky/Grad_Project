    ...
    <PageLayout maxWidth="max-w-lg">
      ...
      <form onSubmit={onSubmit} noValidate>
        ...
        <button type="submit" disabled={loading}
          className="relative w-full flex items-center justify-center gap-2.5 px-5 py-3.5 rounded-2xl text-[14px] font-semibold transition-spring active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden group shadow-lg"
          style={{
            background: 'linear-gradient(135deg, #7c3aed 0%, #6d28d9 50%, #5b21b6 100%)',
            color: '#fff',
            boxShadow: '0 4px 20px rgba(124,58,237,0.35), 0 1px 3px rgba(0,0,0,0.15)',
          }}
        >
          ...
          {loading ? (
            ...
            <>
              <Save className="w-4 h-4 transition-transform duration-200 group-hover:-rotate-6" />
              Update Password
            </>
          )}
        </button>
